  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-zinc-900">
      ...
      <main className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          <h1 className="text-3xl font-bold text-zinc-900 dark:text-white mb-8 text-center">Sign Up</h1>
          ...
          <p className="text-center mt-6 text-zinc-600 dark:text-zinc-300">
            Already have an account? <Link to="/login" className="text-rose-600 hover:text-rose-700">Login</Link>
          </p>
        </motion.div>
      </main>
